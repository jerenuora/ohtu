...
class TestKauppa(unittest.TestCase):
    def setUp(self):
        ...
        def varasto_hae_tuote(tuote_id):
            ...
            if tuote_id == 3:
                return Tuote(2, "kolmipyörä", 5000)
    ...
    def test_ostoksen_paatyttya_pankin_metodia_tilisiirto_kutsutaan_oikella_arvoilla(self):
    ...
    def test_ostoksen_paatyttya_pankin_metodia_tilisiirto_kutsutaan_oikella_arvoilla_kaksi_eri_tuotetta(self):
    ...
    def test_ostoksen_paatyttya_pankin_metodia_tilisiirto_kutsutaan_oikella_arvoilla_kaksi_samaa_tuotetta(self):
    ...
    def test_ostoksen_paatyttya_pankin_metodia_tilisiirto_kutsutaan_oikella_arvoilla_kaksi_eri_tuotetta_toinen_loppu(self):
